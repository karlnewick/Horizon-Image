...
### Enable WinRM
# write-host "Sleep for 10 seconds waiting for network adpater" -ForegroundColor Red
# start-sleep -s 10
write-host "Rename Network Adapter to Ethernet" -ForegroundColor blue 
netsh interface set interface name = "Ethernet0" newname = "Ethernet"
